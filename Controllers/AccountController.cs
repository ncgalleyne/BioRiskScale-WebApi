...
namespace WebApplication4.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public IHttpActionResult CreateAccount(string f_name, string l_name, string email, string pwd, string loc, string occupation)
        {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            //finish registration by adding rest of fields to database record
            StoreUserExtras(user, model);

            return Ok();
        }

        private void StoreUserExtras(ApplicationUser user, RegisterBindingModel model)
        {
            //call a stored procedure
            masterdb.FinishRegistration(user.Id, model.FirstName, model.LastName, model.Location, model.Occupation);
